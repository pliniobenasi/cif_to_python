...
CIF_PATH="${CIF_PATH:-examples/coffee_machine.cif}"
MODEL_NAME="$(basename "$CIF_PATH" .cif)"
GENERATED_DIR="out/generated/$MODEL_NAME"
EVENTS_CSV="${EVENTS_CSV:-examples/coffee_machine_events.csv}"
...
HISTORY_VAR="${HISTORY_VAR:-CoffeeMachine_0_location}"
DEFAULT_TARGET="${DEFAULT_TARGET:-CoffeeMachine}"
